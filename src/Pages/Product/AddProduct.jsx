  ...
  return (
    <div className='flex flex-col w-full items-center p-2'>
        <div className='flex flex-row w-full pb-4'>
            <p className='px-4 py-2 rounded-md bg-slate-800 text-white'>Add Product</p>
        </div>
        ...
        <div className='w-fit flex flex-row bg-green-400 text-white rounded-xl justify-center px-4 py-2 my-4 cursor-pointer select-none' onClick={showToast}>
            Add Product
        </div>     
        <ToastContainer/>
      <div className='h-44'>
